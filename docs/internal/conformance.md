...
| Hosted comparison | `hosted comparison fixture` records hosted-vs-local checkpoint, optimizer-resume, metrics, and sampler shape evidence. | Covered for recorded shapes; numeric and authorization differences remain caveats. |
